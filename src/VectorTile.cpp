...
namespace flightsimlib::cgl
{
    ...
    static const auto road_fixups =
        to_array<RoadFixup>({{0x0102D8D6, -1, -1, -1}, {0x0102D8E3, -1, -1, -1}, {0x0103782D, -1, -1, -1},
            {0x01037833, -1, -1, -1}, {0x01037834, -1, -1, -1}, {0x01037835, -1, -1, -1}, {0x01037844, -1, -1, -1},
            {0x01037855, -1, -1, -1}, {0x0104718C, -1, -1, -1}, {0x010471AE, -1, -1, -1}, {0x01047CE1, -1, -1, -1},
            {0x00817821, 8, 12, -1}, {0x0081781E, 8, 12, -1}, {0x01E830C0, 14, -1, -1}, {0x01E83101, 14, -1, -1},
            {0x01E83136, 14, -1, -1}, {0x01E830B7, 14, -1, -1}, {0x01E7C672, 12, 14, -1}, {0x01E82FE8, 12, 14, -1},
            {0x01E83151, 12, 14, -1}, {0x01E8315E, 12, 14, -1}, {0x01E83171, 12, 14, -1}, {0x01E82F33, 8, 12, -1},
            {0x01E82EC4, 12, 14, -1}, {0x01E8315F, -1, -1, -1}, {0x01E83163, -1, -1, -1}, {0x01E82EE8, 14, -1, -1},
            {0x01E83154, 12, 14, -1}, {0x01E83152, 12, 14, -1}, {0x01E82FA3, 12, 14, -1}, {0x01E83170, 12, 14, -1},
            {0x04D097A7, -1, -1, -1}, {0x00F2488E, -1, -1, -1}, {0x01BCF210, -1, -1, -1}, {0x03F6FAE8, -1, -1, -1},
            {0x055342B7, -1, -1, -1}, {0x06D680A9, -1, -1, -1}, {0x06357AAC, -1, -1, -1}, {0x0676006B, -1, -1, -1},
            {0x067600F8, -1, -1, -1}, {0x067600FD, -1, -1, -1}, {0x06760395, -1, -1, -1}, {0x0676039F, -1, -1, -1},
            {0x067603BD, -1, -1, -1}, {0x067603C0, -1, -1, -1}, {0x067603C2, -1, -1, -1}, {0x067603C5, -1, -1, -1},
            {0x067603DB, -1, -1, -1}, {0x005CC197, -1, -1, -1}, {0x01D4862F, -1, -1, -1}, {0x01D47EFE, -1, -1, -1},
            {0x0628E1E0, -1, -1, -1}, {0x0628E1AD, -1, -1, -1}, {0x027EF4EA, -1, -1, -1}, {0x027EF4EB, -1, -1, -1},
            {0x0728AD25, -1, -1, -1}, {0x05AC979C, -1, -1, -1}, {0x04BDF011, -1, -1, -1}, {0x06EF8996, -1, -1, -1},
            {0x06533E90, -1, -1, -1}, {0x06533923, -1, -1, -1}, {0x06533E89, -1, -1, -1}, {0x005EB09D, -1, -1, -1},
            {0x0623E32B, -1, -1, -1}, {0x06F3C47C, -1, -1, -1}, {0x0391FA99, -1, -1, -1}, {0x04460CB0, -1, -1, -1},
            {0x008A4916, -1, -1, -1}, {0x05216484, -1, -1, -1}, {0x05E3DFE6, -1, -1, -1}, {0x0623E32B, -1, -1, -1},
            {0x07FFFFFF, -1, -1, -1}, {0x033F34AA, -1, -1, -1}, {0x029F7146, -1, -1, -1}, {0x04DAA4CD, -1, -1, -1},
            {0x027B8B1D, -1, -1, -1}, {0x03825BAF, -1, -1, -1}, {0x0265A627, -1, -1, -1}, {0x0265A626, -1, -1, -1},
            {0x0265A0DB, -1, -1, -1}, {0x0265A632, -1, -1, -1}, {0x0265A629, -1, -1, -1}, {0x0265A62C, -1, -1, -1},
            {0x0265A62D, -1, -1, -1}, {0x0265A62E, -1, -1, -1}, {0x0265A62F, -1, -1, -1}, {0x0265A630, -1, -1, -1},
            {0x0265A631, -1, -1, -1}, {0x0478B01E, -1, -1, -1}, {0x02D6B3B5, -1, -1, -1}, {0x02D6B3C1, -1, -1, -1},
            {0x05797AD3, -1, -1, -1}, {0x0360131D, -1, -1, -1}, {0x03601310, -1, -1, -1}, {0x0360130C, -1, -1, -1},
            {0x0360130E, -1, -1, -1}, {0x0360130B, -1, -1, -1}, {0x0455DB55, -1, -1, -1}, {0x0455DB85, -1, -1, -1},
            {0x0455DB89, -1, -1, -1}, {0x0455DB88, -1, -1, -1}, {0x0664B2E2, -1, -1, -1}, {0x051BDA74, -1, -1, -1},
            {0x05FDF782, -1, -1, -1}, {0x01E1E701, -1, -1, -1}, {0x01E1E6FD, -1, -1, -1}, {0x01E1E6FE, -1, -1, -1},
            {0x014875AB, -1, -1, -1}, {0x06F91748, -1, -1, -1}, {0x02054E70, -1, -1, -1}, {0x02054E70, -1, -1, -1}});

    double normalized_to_lat(double norm) { return 90.0 - atan(exp(norm * 2 * m_pi - m_pi)) * (360.0 / m_pi); }

    double normalized_to_lon(double norm) { return (norm - 0.5) * 360.0; }

    bool IsValidHeight(float val) { return !std::isnan(val) && val > -750.0f && val < 10000.0f; }
    ...
    void VectorTile::VertexToLatLon(geo::LatLon& ll, const VectorVertex& vertex) const
    {
        ...
        ll.Lon = m_bounds.tl_lon +
                 m_bounds.delta_lon * static_cast<double>(vertex.Start) * 0.00001525902189669642175936522469;
        ll.Lat =
            m_bounds.tl_lat + m_bounds.delta_lat * static_cast<double>(vertex.End) * 0.00001525902189669642175936522469;
    }
    ...
    void VectorTile::CalcBounds()
    {
        ...
        const auto overlap_y = static_cast<double>(m_bounds.overlap_factor) * 0.000008983152841195214 +
                               pixel_ratio * 0.00000002495320233665337 + 0.001122894105149402;
        ...
        m_bounds.tile_width =
            static_cast<float>((overlap_x + overlap_x) / (m_bounds.delta_lon - (overlap_x + overlap_x)) + 1.0);
        m_bounds.tile_height =
            static_cast<float>((overlap_y + overlap_y) / (m_bounds.delta_lat - (overlap_y + overlap_y)) + 1.0);
    }
    ...
    auto VectorTile::GetRoadVertexAt(int index) const -> const VectorVertex* { return &RoadVertices[index]; }
    ...
    auto VectorTile::GetLandVertexAt(int index) const -> const VectorVertex* { return &LandVertices[index]; }
    ...
    auto VectorTile::GetWaterVertexAt(int index) const -> const VectorVertex* { return &WaterVertices[index]; }
    ...
    auto VectorTile::GetWaterFeatureAt(int index) const -> const WaterFeature* { return &WaterFeatures[index]; }

    auto VectorTile::GetWaterFeatureCount() const -> int { return static_cast<int>(WaterFeatures.size()); }

    auto VectorTile::GetRiverVertexAt(int index) const -> const VectorVertex* { return &RiverVertices[index]; }

    auto VectorTile::GetRiverFeatureAt(int index) const -> const RiverFeature* { return &RiverFeatures[index]; }

    auto VectorTile::GetRiverFeatureCount() const -> int { return static_cast<int>(RiverFeatures.size()); }
    ...
    auto VectorTile::GetRailVertexAt(int index) const -> const VectorVertex* { return &RailVertices[index]; }
    ...
    auto VectorTile::GetPowerVertexAt(int index) const -> const VectorVertex* { return &PowerVertices[index]; }
    ...
    auto VectorTile::GetUnknown1VertexAt(int index) const -> const VectorVertex* { return &Unknown1Vertices[index]; }
    ...
    auto VectorTile::GetUnknown2VertexAt(int index) const -> const VectorVertex* { return &Unknown2Vertices[index]; }
    ...
    {
        static float road_widths[16] = {
            12.5f, 12.5f, 12.5f, 12.5f, 12.5f, 10.0f, 10.0f, 10.0f, 10.0f, 10.0f, 10.0f, 10.0f, 10.0f, 7.5f, 3.0f};
        ...
        for (auto i = 0u; i < RoadTypes.size() - 1; ++i)
        {
            for (auto* road = RoadTypes[i]; road < RoadTypes[i + 1LL]; ++road)
            {
                ...
                if (m_quad.level == 14 && m_quad.tile_x == 8157 && (m_quad.tile_y == 4718 || m_quad.tile_y == 4719))
                {
                    road->Flags &= 0xBF;
                    road->Flags |= 0x20;
                }
    ...
    auto VectorTile::ToBinary(io::IBinaryStream& stream) -> void
    {
        ...
        const auto has_points = m_version > 20 ? pack_bitmask<uint32_t>(stream, PointTypes, PointVertices)
